/*
* Les Grandes Parties
* 1/ Fonctions anonymes, closures et callback avec bonnes pratiques 
* 2/ Utilisation et Configuration de Bower avec initialisation (git, node et npm). Librarie Lodash,Librarire Bootsrapp, Librairie font-awesome,  Librarie Jquery
* 3/ Utilisation de Gulp (ecrire en Nodejs) avec package.json simple: https://github.com/Symfomany/jsopen/blob/master/gulpfile.js et https://github.com/Symfomany/tchat/blob/master/gulpfile.js
* 4/ Découverte de SASS: language et couplage avec Gulp

* 4/ Utilisation de Browserify
* 2/ Implémentatioon de l'ES6 présent dans React ou Angular avec Babel
* 3/ 
*/
 ...
 * Rappel de la Doc
 * Rappel Indenter / aerer et commenter
 ...
 * Rappel typeof dans le if() / triple ===
 */
...
//i pour le nombre de notes et 2 compteurs de note > et < à 10
var compteur = notes.length - 1;
var noteSupp10 = noteInf10 = 0;


//Tant qu'il reste des notes a vérifier
while (compteur > 0) { 
...
//variable pour mettre un "s" ou pas a note
var k = l = "";
...
console.log("Vous avez eu "+noteSupp10+" note"+k+" au dessus de la moyenne et "+noteInf10+" note"+l+" en dessous de la moyenne");


// Affiche les occurences pour chaque notes
// Trie le tableau du plus petit au plus grand
notes = notes.sort(); // sort() permet de trier un tableau
var compteur = 0;

while (notes.length > compteur) {
       
  			// Occurances renvoie le nombre d'occurence de la première entrée d'un tableau
        var occurances = notes.filter(function(val){
           // si val : element courant dans une boucle invisible
          // est égal au nombre courantd e ma boucle principal
        	return val === notes[compteur];
        }).length;
  
        // Affiche la note et son nombre d'occurence
        console.log("vous avez eu la note de "+notes[compteur]+" "+occurances+" fois.");
        compteur = compteur + occurances;
}

//affiche les valeur max et min
var max = 0;
...
console.log("La note minimal est de : "+min+" / 20.");
